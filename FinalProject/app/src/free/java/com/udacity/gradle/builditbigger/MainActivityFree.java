...
public class MainActivityFree extends AppCompatActivity implements JokerEndPointResult{
    ...
    public void showProgress(boolean show) {
        MainActivityFragmentFree mainActivityFragment = (MainActivityFragmentFree) getSupportFragmentManager().getFragments().get(0);
